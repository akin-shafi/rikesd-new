...
<div class="row" id="analytic">
    <div class="col-12">
        <div class="justify-content-between d-flex">
            ...
            <div>
                <a class="btn btn-primary" href="<?php echo url_for('public/team/new.php') ?>">+ Add New</a>
                        ...
                        <tbody>
                            ...
                            foreach (Team::find_by_undeleted() as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <img width="50"
                                            src="<?php echo url_for_root('assets/img/leaders/' . $value->photo) ?>" alt=""
                                            srcset="">
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo url_for('public/team/edit.php?id=' . $value->id) ?>"
            ...
            <div class="modal-body">
                ...
                <form class="ps-3 pe-3 row" id="form">
                    ...
                    <div class="mb-3 col-lg-6 col-md-6">
                        ...
                        <input class="form-control" name="phone" type="phone" required="" id="phone"
