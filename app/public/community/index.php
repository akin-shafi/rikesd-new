...
?>
	<div class="row">
		<div class="col-12">
			<a href="<?php echo url_for('public/community/exportData.php') ?>" class="btn btn-success my-2"> <i class="fa fa-file-excel-o"></i> Export CSV</a>
			<div class="card">
				<div class="card-body">
					...
					<table id="basic-datatable" class="table dt-responsive nowrap w-100">
					    ...
					    <tbody>
					    	<?php $sn = 1; foreach (Newsletter::find_by_undeleted() as $key => $value) { ?>
					        <tr>
					            <td><?php echo $sn++ ?>.</td>
