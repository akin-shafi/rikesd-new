...
$academic =  AimAcademicApplicants::find_all();
$industry  = AimIndustryApplicants::find_all();
?>
...
<style type="text/css">
    ...
    <div class="row" id="analytic">
        ...
        <a href="<?php echo url_for('public/team/') ?>" class="col-lg-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h5 class="text-muted fw-normal mt-0 text-truncate" title="Global Leaders">Global Leaders</h5>
                            <h3 class="my-2 py-1"><?php echo count(Team::find_by_undeleted()); ?></h3>
        ...
        <a href="<?php echo url_for('public/explore/') ?>" class="col-lg-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h5 class="text-muted fw-normal mt-0 text-truncate" title="Community member">Explorations</h5>
                            <h3 class="my-2 py-1"><?php echo count(Blog::find_by_undeleted()); ?></h3>
                            <!-- <p class="mb-0 text-muted">
        ...
        <a href="<?php echo url_for('public/aim/') ?>" class="col-lg-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h5 class="text-muted fw-normal mt-0 text-truncate" title="Community member">AIM Applications</h5>
                            <h3 class="my-2 py-1"><?php echo count($academic + $industry); ?></h3>
                            <!-- <p class="mb-0 text-muted">
                                <span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i> 11.7%</span>
                            </p> -->
                        </div>
        ...
        <a href="<?php echo url_for('public/requests/') ?>" class="col-lg-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h5 class="text-muted fw-normal mt-0 text-truncate" title="Project Expressions">Project Expressions</h5>
                            <h3 class="my-2 py-1"><?php echo count(NewProject::find_by_undeleted()); ?></h3>
                        </div>
                        <div class="col-6">
                            <div class="text-end">
                                <div id="booked-revenue-chart" data-colors="#42d29d"></div>
