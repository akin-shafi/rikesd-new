...
if (is_post_request()):
  ...
  $modifiedString = str_replace(' ', '_', $blogArgs['title']);
    ...
    <div class="card-body">
      ...
      <main class="row">
        <div class=" col-lg-4 col-md-4 border p-2 mb-3">
          ...
          <input type="text" class="form-control" name="blog[duration]" id="duration"
            value="<?php echo $blog->duration; ?>" placeholder="Enter duration">
        </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="blog[title]" value="<?php echo $blog->title; ?>" id="title"
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="blog[summary]" value="<?php echo $blog->summary; ?>" id="summary"
          placeholder="Enter summary">
      </div>
      <div class="mb-3">
        <label for="editor" class="form-label">Description</label>
        <textarea class="form-control" name="blog[description]" id="editor" rows="5"
          placeholder="Enter Description"><?php echo $blog->description; ?></textarea>
      </div>
