...
?>
  ...
  <div class="container">
  <a href="<?php echo url_for('public/explore/') ?>" class="btn btn-outline-primary btn-sm mt-2 mb-2">Back to List</a>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">
                <a href="<?php echo url_for('/public/explore/category/edit.php?id=' . $category->id); ?>"
                  class="btn btn-sm btn-outline-success">Edit</a>
                <a href="<?php echo url_for('/public/explore/category/delete.php?id=' . $category->id); ?>"
                  class="btn btn-sm btn-primary">Delete</a></th>
            </tr>
            <?php endforeach; ?>
          </tbody>
        </table>
