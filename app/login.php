    ...
    if ($login) {
        ...
        if (empty($errors)) {
            ...
            if ($user != false && $user->verify_password($password)) {
                ...
                log_action('Admin Login', "{$user->full_name()} Logged in.", "login");
                ...
                <div class="col-xxl-4 col-lg-5">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="email" id="emailaddress" name="login[email]"
                                        required="" placeholder="Enter your email">
                                </div>

                                <div class="mb-3">
                                    <a href="pages-recoverpw" class="text-muted float-end"><small>Forgot your
                                            password?</small></a>
                    ...
                    <div class="row mt-3 d-none">
                        <div class="col-12 text-center">
                            <p class="text-muted">Don't have an account? <a href="pages-register"
