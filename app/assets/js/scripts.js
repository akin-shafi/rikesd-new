...
jQuery(function ($) {
  ...
  // subscribe form
  function subscriptionMail(usermail) {
    $.ajax({
        url: 'app/processor/subscriptionMail.php',
        method:"POST",
        data: {
            subscriptionMail: 1,
            email: usermail,
  ...
  $(document).on("submit", "#subscribe-form", function(e){
        e.preventDefault();
        var usermail   = $("#subscribe-form #mce-EMAIL").val();
        
        if (usermail == '') {
            errorAlert("Please enter your email");
        }else{
            $.ajax({
                url: 'inc/subscribe-process.php',
                method:"POST",
  ...
  // contact form
    ...
    function submitContactForm(){
        // Initiate Variables With Form Content
        var name    = $("#contactForm #cname").val();
        var email   = $("#contactForm #cemail").val();
        var phone   = $("#contactForm #cphone").val();
        // var company = $("#contactForm #company").val();
        var message = $("#contactForm #cmessage").val();


        $.ajax({
            url: 'inc/contact-form-process.php',
            method:"POST",
            // data: $('#contact_form').serialize(),
