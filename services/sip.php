    ...
    <div class="row">
        <div class="col-md-9 col-lg-9 mx-auto" data-zanim-timeline="{}" data-zanim-trigger="scroll">
          ...
          <div class="card" data-zanim-xs='{"delay":0.1,"duration":1}'>
            ...
            <div id="content">
                <div class="container">
                <h5 class="mb-4">Enrollment Form</h5>
                    <p class="lead">Introducing the Technology-Based Skill Intensification Program!</p>
                    <p>
                    Step into the digital age and thrive in today's fast-paced world with our comprehensive program. Our interactive courses and workshops are designed to empower you with the latest technological expertise. Whether you're just starting out or an experienced professional, our program caters to all skill levels. Join us today and discover your limitless possibilities!
                    </p>
                    <form action="#" class="row" method="POST">
                      ...
                      <div class="form-group mb-3 col-lg-12">
                          <label for="expectations" class="form-label">Expectations from the Program <span class="text-danger">*</span></label>
