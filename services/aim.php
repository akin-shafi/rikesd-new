...
// $applicationList = ['AIM for Academia', 'AIM for Institution', 'AIM for Industries'];
$applicationList = ['AIM for Institution', 'AIM for Industries'];
?>
        ...
        <div class="card-body p-md-5" id="formbody">
          ...
          <div class=" p-0 d-flex justify-content-center">
            <ul class="fab-nav nav nav-tabs mb-2" id="myTab" role="tablist">
              ...
              <?php foreach ($applicationList as $index => $value):
                ?>
                <li class="nav-item ">
                  <a class="nav-link <?php echo $index == $application_type ? 'active' : '' ?>"
                    onclick="changeTab('', <?php echo $activeTab ?>, <?php echo $index ?>)"><?php echo $value ?></a>
                </li>
              <?php endforeach; ?>
            </ul>
          </div>
          ...
          <div id="content">
            ...
            if (!isset($application_type) || $application_type == 0) {
              include('form_field_institution.php');
            } else {
