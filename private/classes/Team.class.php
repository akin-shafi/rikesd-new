...
class Team extends DatabaseObject
{
    ...
    protected static $db_columns = ['id','category', 'nda_status', 'fullname', 'gender', 'personality','position', 'head','email','phone','brief_biography','photo','created_at','updated_at','deleted'];
