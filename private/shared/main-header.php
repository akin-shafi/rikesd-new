    ...
    <div class="container">
      <div class="row align-items-center gx-4">
        ...
        <div class="col-auto"><span class="fas fa-phone-alt text-success" data-fa-transform="shrink-3"></span><a
            class="ms-2 fs--1 d-inline text-white fw-bold" href="tel:2123865575">+234 703 938 8978, +234 708 201
            6126</a></div>
      </div>
      <!-- <div class="row align-items-center gx-4">
            ...
            <ul class="navbar-nav py-3 py-lg-0 mt-1 mb-2 my-lg-0 ms-lg-n1">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link <?php echo $page_title == 'About' ? 'active' : '' ?>  dropdown-toggle dropdown-indicator"
                  href="JavaScript:void(0)" role="button" data-bs-toggle="dropdown" aria-expanded="false">About Us</a>
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="<?php echo url_for_root('/about') ?>">Overview</a></li>
                  <li><a class="dropdown-item" href="<?php echo url_for_root('/mission') ?>">Mission & Objectives</a></li>
                </ul>
              </li>

              <li class="nav-item dropdown d-none">
                <a class="nav-link <?php echo $page_title == '' ? 'active' : 'News' ?> dropdown-toggle dropdown-indicator"
                  href="JavaScript:void(0)" role="button" data-bs-toggle="dropdown" aria-expanded="false">News</a>
                <ul class="dropdown-menu">
              ...
              <li class="nav-item dropdown"><a
                  ...
                  href="JavaScript:void(0)" role="button" data-bs-toggle="dropdown" aria-expanded="false">Global
                  Leaders</a>
                <ul class="dropdown-menu">
                  <?php foreach ($categories as $key => $val): ?>
                    <li class="">

                      <a class="dropdown-item" href="<?php echo url_for_root('/team/index?tab=' . $val->id) ?>"><?= $val->name ?></a>
                    </li>
                  <?php endforeach; ?>
                </ul>
              </li>
              ...
              <li class="nav-item dropdown d-none"><a
                  ...
                  href="JavaScript:void(0)" role="button" data-bs-toggle="dropdown" aria-expanded="false">Research for
                  Impact</a>
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="<?php echo url_for_root('registration') ?>">Knowledge Marketplace</a>
                  </li>
                  <li><a class="dropdown-item" href="<?php echo url_for_root('registration') ?>">Mentorship</a></li>
                  <li><a class="dropdown-item" href="<?php echo url_for_root('registration') ?>">RDI Infrastructure</a>
                  </li>
                  <li><a class="dropdown-item" href="<?php echo url_for_root('registration') ?>">RDI Institutes and
                      Centers</a></li>
                </ul>
              </li>
                ...
                <ul class="dropdown-menu">
                  <?php foreach (Services::find_by_category(['category' => '1']) as $key => $value): ?>
                    <li><a class="dropdown-item"
                        href="<?php echo url_for_root('services/' . $value->page . '?tab=' . $value->id) ?>"><?php echo $value->item; ?></a></li>
                  <?php endforeach ?>
                </ul>
              </li>
          ...
          <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                  <?php foreach (Services::find_by_category(['category' => '2', 'sub_category' => 0]) as $key => $value): ?>



                    <?php if ($value->sub_category == 0 && $value->has_sub == 1) { ?>
                      <li class="nav-item dropdown">
                        <a class="nav-link <?php echo $page_title == $value->item ? 'active' : '' ?> dropdown-toggle" href="#"
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                          <?php foreach (Services::find_by_category(['category' => '3', 'sub_category' => $value->id]) as $key => $menuData): ?>
                            <li>
                              <a class="dropdown-item"
                                href="<?php echo url_for_root($menuData->page . '?tab=' . $menuData->id) ?>">
                                <!-- Available funding Opportunities -->
                                <?php echo $menuData->item ?>
                              </a>
                            </li>
                          <?php endforeach ?>
                    ...
                    <?php } else { ?>
                      <li class="nav-item">
                        <a class="nav-link <?php echo $page_title == $value->item ? 'active' : '' ?>"
                          href="<?php echo url_for_root($value->page . '?tab=' . $value->id) ?>">
                          <?php echo $value->item; ?></a>
                      </li>
                    <?php } ?>
