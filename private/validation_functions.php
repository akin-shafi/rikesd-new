...
function has_unique_email_team($client_email, $current_id = "0")
{

  $email = Team::find_by_email($client_email);
...
function has_unique_email_aim_academic($client_email, $current_id = "0")
{

  $email = AimAcademicApplicants::find_by_email($client_email);
...
function has_unique_email_aim_industry($client_email, $current_id = "0")
{

  $email = AimIndustryApplicants::find_by_email($client_email);
...
function has_unique_email_aim_institution($client_email, $current_id = "0")
{

  $email = AimInstitution::find_by_email($client_email);
