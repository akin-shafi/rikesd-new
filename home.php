            ...
            <div class="col-sm-8 col-lg-7 px-5 px-sm-3">
              ...
              <div class="overflow-hidden">
                <p class="text-primary pt-4 mb-5 fs-1 fs-md-2 lh-xs" data-zanim-xs='{"delay":0.1}'>
                  Empowering communities through Research, Innovation, Development and Enterprise for Sustainable
                  Development.</p>
              </div>
              <div class="overflow-hidden">
      ...
      <div class="swiper-slide" data-zanim-timeline="{}">
        ...
        <div class="container">
          <div class="row min-vh-100 py-8 align-items-center" data-inertia='{"weight":1.5}'>
            <div class="col-sm-8 col-lg-7 px-5 px-sm-3">
              <div class="overflow-hidden">
                <h1 class="fs-4 fs-md-5 lh-1" data-zanim-xs='{"delay":0}'>Experts & Consultants</h1>
              </div>
              <div class="overflow-hidden">
                <p class="text-primary pt-4 mb-5 fs-1 fs-md-2 lh-xs" data-zanim-xs='{"delay":0.1}'>Unlock new insightful
                  heights for your Institutions & Organisation with RIKESD's expertise in Research for Impact and
        ...
        <div class="container">
          <div class="row min-vh-100 py-8 align-items-center" data-inertia='{"weight":1.5}'>
            <div class="col-sm-8 col-lg-7 px-5 px-sm-3">
              ...
              <div class="overflow-hidden">
                <p class="text-primary pt-4 mb-5 fs-1 fs-md-2 lh-xs" data-zanim-xs='{"delay":0.1}'>Connect with a team
                  of globally accomplished experts and researchers to drive comprehensive solutions for circular growth.
                </p>
              </div>
              <div class="overflow-hidden">
                <div data-zanim-xs='{"delay":0.2}'>
      ...
      <div class="swiper-slide" data-zanim-timeline="{}">
        ...
        <div class="container">
          <div class="row min-vh-100 py-8 align-items-center" data-inertia='{"weight":1.5}'>
            <div class="col-sm-8 col-lg-7 px-5 px-sm-3">
              <div class="overflow-hidden">
                <h1 class="fs-4 fs-md-5 lh-1" data-zanim-xs='{"delay":0}'>Contract Research</h1>
              </div>
              <div class="overflow-hidden">
                <p class="text-primary pt-4 mb-5 fs-1 fs-md-2 lh-xs" data-zanim-xs='{"delay":0.1}'>
                  Accelerate Innovation with Contract Research.
                  Unlock your potential with tailored solutions and expert insights.
  ...
  <div class="container">
    <div class="row justify-content-center text-center">
      <div class="col-10 col-md-6">
        ...
        <p class="px-lg-4 mt-3">A Pan-African not for profit Research as a Service (RaaS) organisation that is leading
          the transformation of communities using <b>RIDE</b>.</p>
        <hr class="short"
    ...
    <div class="row mt-4 mt-md-5">
      <div class="col-sm-6 col-lg-3 mt-4" data-zanim-timeline="{}" data-zanim-trigger="scroll">
        ...
        <p class="mb-0 mt-3 px-3" data-zanim-xs='{"delay":0.2}'>Connect with passionate researchers and experts, <br />
          Collaborate and unlock new opportunities with RIKESD Experts Community.</p>
      </div>
      <div class="col-sm-6 col-lg-3 mt-4" data-zanim-timeline="{}" data-zanim-trigger="scroll">
        ...
        <p class="mb-0 mt-3 px-3" data-zanim-xs='{"delay":0.2}'>Drive meaningful change with RIKESD's Research for
          Impact. Make a difference through impactful research projects.</p>
      </div>
      <div class="col-sm-6 col-lg-3 mt-4" data-zanim-timeline="{}" data-zanim-trigger="scroll">
        ...
        <p class="mb-0 mt-3 px-3" data-zanim-xs='{"delay":0.2}'>Exchange valuable insights and expertise. Expand
          learning with RIKESD Knowledge Marketplace</p>
      </div>
      <div class="col-sm-6 col-lg-3 mt-4" data-zanim-timeline="{}" data-zanim-trigger="scroll">
        ...
        <p class="mb-0 mt-3 px-3" data-zanim-xs='{"delay":0.2}'>Access financial support, such as mentorship, and
          resources for impactful research and academic pursuits.</p>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row flex-center text-center pb-6">
      <div class="col-12">
        <div class="position-relative mt-4 py-5 py-md-11">
          ...
          <!--/.bg-holder-->
          <button class="btn-RIKESD-play" data-bigpicture="{&quot;ytSrc&quot;:&quot;jlWMTNZNOc0&quot;}"
            data-zanim-trigger="scroll"
    ...
    <div class="row">
      <div class="col-sm-6 col-lg-4 mt-3 mt-lg-0 px-4 px-sm-3" data-zanim-timeline="{}" data-zanim-trigger="scroll">
        ...
        <p class="mt-3 pe-3 pe-lg-5" data-zanim-xs='{"delay":0.1}'>Before talking destination, we shine a spotlight
          across your organization <br /> to fully understand it.</p>
      </div>
      <div class="col-sm-6 col-lg-4 mt-3 mt-lg-0 px-4 px-sm-3" data-zanim-timeline="{}" data-zanim-trigger="scroll">
        <h5 data-zanim-xs='{"delay":0}'><span class="text-primary me-3 fas fa-comments"></span>Excellent Support</h5>
        <p class="mt-3 pe-3 pe-lg-5" data-zanim-xs='{"delay":0.1}'>Count on our dedicated 24/7 support team for seamless
          assistance.</p>
      </div>
      <div class="col-sm-6 col-lg-4 mt-3 mt-lg-0 px-4 px-sm-3" data-zanim-timeline="{}" data-zanim-trigger="scroll">
        <h5 data-zanim-xs='{"delay":0}'><span class="text-primary me-3 fas fa-bolt"></span>Faster Performance</h5>
        <p class="mt-3 pe-3 pe-lg-5" data-zanim-xs='{"delay":0.1}'>Experience streamlined progress from concept to
          implementation with our efficient processes.</p>
      </div>
    </div>
  </div><!-- end of .container-->
</section><!-- <section> close ============================-->
  ...
  <div class="container">
      ...
      <div
        ...
        <div class="d-flex align-items-center h-100">
          <div data-zanim-timeline="{}" data-zanim-trigger="scroll">
            ...
            <div class="overflow-hidden">
              <p class="mt-3" data-zanim-xs='{"delay":0.1}'>As one of the world’s largest accountancy networks, RIKESD
                helps a diverse range of clients with a diverse range of needs.This is especially true of our Advisory
      ...
      <div
        ...
        <div class="d-flex align-items-center h-100">
          <div data-zanim-timeline="{}" data-zanim-trigger="scroll">
            ...
            <div class="overflow-hidden">
              <p class="mt-3" data-zanim-xs='{"delay":0.1}'>RIKESD serves clients across the country and around the
                world as they navigate an increasingly complex tax landscape. Our tax professionals draw on deep
                experience and industry-specific knowledge to deliver clients the insights and innovation they need.</p>
            </div>
            <div class="overflow-hidden">
              <div data-zanim-xs='{"delay":0.2}'><a class="d-flex align-items-center" href="#!">Learn More<div
                    class="overflow-hidden ms-2"><span class="d-inline-block"
          ...
          <div data-zanim-timeline="{}" data-zanim-trigger="scroll">
            ...
            <div class="overflow-hidden">
              <p class="mt-3" data-zanim-xs='{"delay":0.1}'>To help you understand what this road looks like, we
                surveyed 1165 digital marketers across Europe and North America to explore current trends and priorities
    ...
    <div class="row mt-7">
      <div class="col-sm-6 col-lg-4 px-4 px-sm-3 mb-4 mb-lg-0" data-zanim-timeline="{}" data-zanim-trigger="scroll">
        <h5 data-zanim-xs='{"delay":0}'><span class="text-primary fs-0 me-3 far fa-credit-card"></span>Special financing
        </h5>
        <p class="mt-3 pe-3 pe-lg-5 mb-0" data-zanim-xs='{"delay":0.1}'>Apply for special financial support and earn
          exclusive rewards.</p>
      </div>
      <div class="col-sm-6 col-lg-4 px-4 px-sm-3 mb-4 mb-lg-0" data-zanim-timeline="{}" data-zanim-trigger="scroll">
        <h5 data-zanim-xs='{"delay":0}'><span class="text-primary fs-0 me-3 fas fa-comment-alt"></span>Chat with team
        </h5>
        <p class="mt-3 pe-3 pe-lg-5 mb-0" data-zanim-xs='{"delay":0.1}'>Have a question? Chat online with an expert. <a
            href='#!'>Start chatting <span class='fas fa-external-link-alt ms-1'></span></a></p>
      </div>
      <div class="col-sm-6 col-lg-4 px-4 px-sm-3 mb-4 mb-lg-0" data-zanim-timeline="{}" data-zanim-trigger="scroll">
        <h5 data-zanim-xs='{"delay":0}'><span class="text-primary fs-0 me-3 fas fa-phone-alt"></span>Call a specialist
        </h5>
        <p class="mt-3 pe-3 pe-lg-5 mb-0" data-zanim-xs='{"delay":0.1}'>Our 24/7 support team is ready for you at
          1-800-MY-RIKESD.</p>
      </div>
    </div>
  </div><!-- end of .container-->
...
<section class="section d-none">
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-6 pe-lg-3"><img class="rounded-3 img-fluid" src="assets/img/why-choose-us.jpg" alt="about" />
      </div>
      <div class="col-lg-6 px-lg-5 mt-6 mt-lg-0" data-zanim-timeline="{}" data-zanim-trigger="scroll">
        <div class="overflow-hidden">
          <div class="px-4 px-sm-0" data-zanim-xs='{"delay":0}'>
            <h5 class="fs-0 fs-lg-1"><span class="fas fa-comment-dots fs-1 me-2" data-fa-transform="flip-h"></span>We
              Are Professional</h5>
            <p class="mt-3">We resource, train, speak, mentor and encourage; marketplace leaders, business owners and
              career professionals to be effective in the workplace.</p>
          </div>
        </div>
        <div class="overflow-hidden">
          <div class="px-4 px-sm-0 mt-5" data-zanim-xs='{"delay":0}'>
            <h5 class="fs-0 fs-lg-1"><span class="fas fa-palette fs-1 me-2" data-fa-transform="shrink-1"></span>We Are
              Creative</h5>
            <p class="mt-3">With so many factors to consider when deciding how to characterize your company , wouldn’t
              it be great to have a group of forward-thinking, well-informed individuals on board who know what they’re
              doing?</p>
          </div>
        </div>
        <div class="overflow-hidden">
          <div class="px-4 px-sm-0 mt-5" data-zanim-xs='{"delay":0}'>
            <h5 class="fs-0 fs-lg-1"><span class="fas fa-stopwatch fs-1 me-2" data-fa-transform="grow-1"></span>24/7
              Great Support</h5>
            <p class="mt-3">Design clever and compelling marketing strategies, improve product positioning, and drive
              conversion rates, RIKESD is all time available to guide you.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row align-items-center">
      <div class="col-md">
        <h4 class="text-white mb-0">
          If you have any questions <br class="d-md-none" /> on Research, Innovation, inventions, technology,
          development and enterprise, we are available 24/7
          <!-- If you have any query related investment... <br class="d-md-none" />we are available 24/7</h4> -->
      </div>
      <div class="col-md-auto mt-md-0 mt-4"><a class="btn btn-light rounded-pill" href="contact.php">Contact Us</a>
      </div>
    </div>
  </div><!-- end of .container-->
</section><!-- <section> close ============================-->
    ...
    <div class="row">
      <div class="col-md-6 col-lg-3 mt-4" data-zanim-timeline="{}" data-zanim-trigger="scroll">
        <div class="px-3 py-4 px-lg-4">
          ...
          <div class="overflow-hidden">
            <p class="mb-0" data-zanim-xs='{"delay":0.2}'>At RIKESD, we channel our creativity to transform communities,
              Institutions, and organisations across AFRICA and beyond.</p>
          </div>
        </div>
      </div>
      <div class="col-md-6 col-lg-3 mt-4" data-zanim-timeline="{}" data-zanim-trigger="scroll">
        <div class="px-3 py-4 px-lg-4">
          ...
          <div class="overflow-hidden">
            <p class="mb-0" data-zanim-xs='{"delay":0.2}'>Through RIKESD, we curate captivating experiences across
      ...
      <div class="col-md-6 col-lg-3 mt-4" data-zanim-timeline="{}" data-zanim-trigger="scroll">
        <div class="px-3 py-4 px-lg-4">
          ...
          <div class="overflow-hidden">
            <p class="mb-0" data-zanim-xs='{"delay":0.2}'>We are leading <b>RIDE</b> enabled impact investment across
              African communities to support the development of prosperous communities.</p>
          </div>
        </div>
      </div>
      <div class="col-md-6 col-lg-3 mt-4" data-zanim-timeline="{}" data-zanim-trigger="scroll">
        <div class="px-3 py-4 px-lg-4">
          ...
          <div class="overflow-hidden">
            <p class="mb-0" data-zanim-xs='{"delay":0.2}'>Guided by a robust strategic framework and extensive research,
              RIKESD facilitates the uptake of research outcomes for MVP development and commercialisation..</p>
          </div>
        </div>
      </div>
    ...
    <div class="row align-items-center text-white">
      <div class="col-lg-4">
        <div class="border border-2 border-success p-4 py-lg-5 text-center rounded-3" data-zanim-timeline="{}"
          ...
          <div class="overflow-hidden">
            <p class="px-lg-1 text-100 mb-0" data-zanim-xs='{"delay":0.1}'>Would you like to speak to one of our experts
              over the phone? Just submit your details and we’ll be in touch shortly. You can also email us if you would
              prefer.</p>
          </div>
        </div>
      </div>
        ...
        <div class="col-sm-6 col-lg-4  mt-4  ">
          <div class="card h-100"><img class="card-img-top" src="assets/img/portrait-3.jpg" alt="Reenal Scott" />
            <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
              ...
              <div class="overflow-hidden">
                <p class="py-3 mb-0" data-zanim-xs='{"delay":0.2}'>Reenal Scott is the Founder and CEO of RIKESD, which he
                  started from his dorm room in 2013 with 3 people only.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="row px-lg-8">
            <div class="col-4 col-md-3 mx-auto"><img class="rounded-3 mx-auto img-fluid" src="assets/img/client1.png"
                alt="Member" /></div>
            <div class="col-md-9 mt-4 mt-md-0 px-4 px-sm-3">
              <p class="lead">Their work on our website and Internet marketing has made a significant different to our
                business. We’ve seen a 425% increase in quote requests from the website which has been pretty remarkable
                – but I’d always like to see more!</p>
        ...
        <div class="swiper-slide">
          <div class="row px-lg-8">
            <div class="col-4 col-md-3 mx-auto"><img class="rounded-3 mx-auto img-fluid" src="assets/img/client2.png"
                alt="Member" /></div>
            <div class="col-md-9 mt-4 mt-md-0 px-4 px-sm-3">
              <p class="lead">Writing case studies was a daunting task for us. We didn’t know where to begin or what
                questions to ask, and clients never seemed to follow through when we asked. RIKESD team did everything –
                with almost no time or effort for me!</p>
        ...
        <div class="swiper-slide">
          <div class="row px-lg-8">
            <div class="col-4 col-md-3 mx-auto"><img class="rounded-3 mx-auto img-fluid" src="assets/img/client3.png"
                alt="Member" /></div>
            <div class="col-md-9 mt-4 mt-md-0 px-4 px-sm-3">
              <p class="lead">As a sales gamification company, we were skeptical to work with a consultant to optimize
                our sales emails, but RIKESD was highly recommended by many other Y-Combinator startups we knew. RIKESD
                helped us run a ~6 week email campaign.</p>
  ...
  <div class="container">
    ...
    <div class="row g-4">
      <div class="col-md-6 col-lg-4">
        <div class="card"><a href="news/news"><img class="card-img-top" src="assets/img/9.jpg"
          ...
          <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
            ...
            <div class="overflow-hidden">
              <p class="mt-3" data-zanim-xs='{"delay":0.2}'>HMRC released a consultation document to flag some potential
                tax impacts that a forthcoming change...</p>
            </div>
            <div class="overflow-hidden">
              <div class="d-inline-block" data-zanim-xs='{"delay":0.3}'><a class="d-flex align-items-center"
                  href="news/news">Learn More<div class="overflow-hidden ms-2"
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card"><a href="news/news"><img class="card-img-top" src="assets/img/10.jpg"
              alt="Featured Image" /></a>
          <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
            <div class="overflow-hidden"><a href="news/news">
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card"><a href="news/news"><img class="card-img-top" src="assets/img/11.jpg"
              alt="Featured Image" /></a>
          <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
            <div class="overflow-hidden"><a href="news/news">
            ...
            <div class="overflow-hidden">
              <p class="mt-3" data-zanim-xs='{"delay":0.2}'>Social engineering involves the collection of information
                from various sources about a target...</p>
            </div>
            <div class="overflow-hidden">
              <div class="d-inline-block" data-zanim-xs='{"delay":0.3}'><a class="d-flex align-items-center"
                  href="news/news">Learn More<div class="overflow-hidden ms-2"
      ...
      <div class="modal-body py-0">
        <div class="row p-0">
          ...
          <div class="col-md-6 p-0">
            <img src="<?php echo url_for_root('assets/img/program/skillnovate.jpeg') ?>" alt="Event Flyer"
              class="img-fluid">
          </div>
          <!-- Right Side -->
          <div class="col-md-6 d-flex justify-content-center align-items-center bg-light">
            <div class="">
              ...
              <h5 class="text-uppercase text-center">SKILLNNOVATE WORKSHOP EP1 - RIKE-SD & UNICCON</h5>
              ...
              <div class="text-center mt-2">
                ...
                <a href="https://forms.gle/xFNLqXA51Gk5zoi58" target="_blank" class="btn btn-primary">Register Now</a>
              </div>
            </div>
          </div>
        </div>
