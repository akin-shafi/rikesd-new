            ...
            <li class="nav-item me-1">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="ph">
                        ...
                        <li><a class="dropdown-item" href="#"><i class="fas fa-folder-open me-2"></i>25 Research output</a></li>
            ...
            <li class="nav-item me-1">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="ph">
                        ...
                        <li><a class="dropdown-item" href="#"><i class="fas fa-folder-open me-2"></i>16 Research output</a></li>
            ...
            <li class="nav-item me-1">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="ph">
                        ...
                        <li><a class="dropdown-item" href="#"><i class="fas fa-folder-open me-2"></i>20 Research output</a></li>
