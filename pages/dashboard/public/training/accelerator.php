...
$course = [
    0 => [
        ...
        'module' => 'GSA MODULE 1',
        'image' => 'road-map.jpeg',
        'title' => 'Course Overview & Guiding Principles',
        'est_time' => '1 Hour',
        'start_date' => 'Feb 21, 2023',
        'complete_date' => 'Feb 24, 2023',
        'score' => '100',
    ],
    // 1 => [
    //     'id' => 2,
    ...
    //     'title' => 'Business Archetypes & Traction Modeling',
    //     'est_time' => '2 Hour',
...
//Commented out until you can complete -->
            ...
            <div class="text-center">
                <a class=" btn btn-primary" data-bs-toggle="collapse" href="#collapseExample<?php echo $value['id'] ?>"
                    ...
                    Expand <i class="mdi mdi-chevron-down-circle-outline"></i>
                </a>
            </div>
            <div class="collapse" id="collapseExample<?php echo $value['id'] ?>">
                <div class="main-wrapper mb-0">
                            ...
                            <div class="w-100 border pt-4 p-md-5 mt-3 mb-5 rounded">
                                <div class="lesson-container d-flex flex-column flex-lg-row">
                                    <div class="col-12 col-lg-8 d-flex flex-wrap justify-content-between">
                                        ...
                                        <span class="Lesson_info col-12 col-lg-5 p-0 my-md-auto mr-lg-1 align-self-center">
                                    ...
                                    <div class="col-12 col-lg-4 text-center d-flex align-items-center lesson-count">
                                        <div class="mobile-spacer d-flex col-12">
                                            <span class="col-8 text-left align-self-center p-0 p-lg-1 text-nowrap"><strong>50%
                    ...
                    <div class="text-center">
                        <a class="btn btn-primary" data-bs-toggle="collapse"
                            ...
                            Collapse <i class="mdi mdi-chevron-up-circle-outline"></i>
                        </a>
