      ...
      <section class="section text-center py-0">
        ...
        <div class="container">
          <div class="row min-vh-100 align-items-center text-white">
            <div class="col" data-zanim-timeline="{}" data-zanim-trigger="scroll"><a href="/" data-zanim-xs='{"delay":0}'><img src="assets/img/logo-dark.png" width="250" alt="logo" data-zanim-xs='{"delay":0.1}' /></a>
