          ...
          <div class="row">
                      ...
                      <div class="col-10">
                        ...
                        <div class="row my-4">
                          ...
                          <div class="col-10">
                            <h5 class="mb-1">Post Heading</h5>
                            <p class="fs--1 text-500">May 15, 2017 at 9:33 am</p>
                            <p>Writing case studies was a daunting task for us. We didn’t know where to begin or what questions to ask, and clients never seemed to follow through when we asked. RikeSD team did everything – with almost no time or effort for me!</p><a class="d-block my-3 text-end me-4" href="#!">Reply</a>
                          </div>
                        </div>
                        <hr class="muted" />
                      </div>
            ...
            <div class="col-lg-4 text-center ms-auto mt-5 mt-lg-0">
              <div class="px-2">
                <div class="card mb-5">
                  <div class="card-body p-5">
                    <div class="overflow-hidden" data-zanim-timeline="{}" data-zanim-trigger="scroll"><img class="rounded-circle" data-zanim-xs='{"delay":0}' src="../assets/img/portrait-8.jpg" alt="Author" />
                      <h5 class="text-capitalize mt-3 mb-0" data-zanim-xs='{"delay":0.1}'>thomas been</h5>
                      <p class="mb-0 mt-3" data-zanim-xs='{"delay":0.2}'>Flattering high rise easy care flared fit - cut straight leg that flares at the ankle comfy tight. Regular fit viscose elastane leather black wool.</p>
                    ...
                    <div class="swiper news-slider pb-4" data-swiper='{"loop":true,"slidesPerView":1,"pagination":{"el":".swiper-pagination","type":"bullets","clickable":true}}'>
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <div class="card"><a href="news"><img class="card-img-top" src="../assets/img/9.jpg" alt="Featured Image" /></a>
                            <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                              <div class="overflow-hidden"><a href="news">
                              ...
                              <div class="overflow-hidden">
                                <div class="d-inline-block" data-zanim-xs='{"delay":0.3}'><a class="d-flex align-items-center" href="news">Learn More<div class="overflow-hidden ms-2" data-zanim-xs='{"from":{"opacity":0,"x":-30},"to":{"opacity":1,"x":0},"delay":0.8}'><span class="d-inline-block fw-medium">&xrarr;</span></div></a></div>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="swiper-slide">
                          <div class="card"><a href="news"><img class="card-img-top" src="../assets/img/10.jpg" alt="Featured Image" /></a>
                            <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                              <div class="overflow-hidden"><a href="news">
                        ...
                        <div class="swiper-slide">
                          <div class="card"><a href="news"><img class="card-img-top" src="../assets/img/11.jpg" alt="Featured Image" /></a>
                            <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                              <div class="overflow-hidden"><a href="news">
