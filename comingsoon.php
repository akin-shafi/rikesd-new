...
$tab = $_GET['tab'] ?? '';
$list = ['', 'Discover', 'MarketPlace', 'Collaborate', 'Fund a research', 'RDI Infrastructure'];
?>
...
<!-- ============================================-->
<!-- <section> begin ============================-->
<section class="section text-center" style="padding-top: 7.5rem !important;padding-bottom: 7.5rem !important;">
  ...
  <div class="container">
    <div class="row min-vh-100 align-items-center text-white">
      <div class="col" data-zanim-timeline="{}" data-zanim-trigger="scroll"><a href="<?= url_for_root('/') ?>" data-zanim-xs='{"delay":0}'><img src="assets/img/logo-dark.png" width="250" alt="logo" data-zanim-xs='{"delay":0.1}' /></a>
        <h5 class="text-uppercase mt-5 ls text-white fs-0 fs-md-1" data-zanim-xs='{"delay":0.2}'><?= $list[$tab] ?></h5>
        <h1 class="fs-2 fs-sm-4 fs-md-6 text-white" data-zanim-xs='{"delay":0.3}'>Coming Soon</h1>
