...
<!-- Mirrored from prium.github.io/RikeSD/v3.0.0/pages/registration by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 Jun 2023 12:58:54 GMT -->
...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>RikeSD | Beautiful Site Template for Agencies &amp; Professionals</title>
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="text-center py-0">
        <div class="bg-holder overlay overlay-1" style="background-image:url(assets/img/background-1.jpg);"></div>
        <!--/.bg-holder-->
        <div class="container">
          <div class="row min-vh-100 align-items-center">
            <div class="col-md-9 col-lg-6 mx-auto" data-zanim-timeline="{}" data-zanim-trigger="scroll">
              <div class="mb-5" data-zanim-xs='{"delay":0,"duration":1}'><a href="index"><img src="assets/img/logo-dark.png" width="150" alt="logo" /></a></div>
              <div class="card" data-zanim-xs='{"delay":0.1,"duration":1}'>
                <div class="card-body p-md-5">
                  <h4 class="text-uppercase fs-0 fs-md-1">create your RikeSD account</h4>
